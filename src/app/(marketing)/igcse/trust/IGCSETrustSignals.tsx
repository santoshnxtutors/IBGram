  ...
  return (
    <section className="border-y border-border/10 bg-background py-6 md:py-8">
      <div className="container mx-auto max-w-6xl px-4">
        <p className="mb-5 text-center text-[11px] font-black uppercase tracking-[0.28em] text-muted-foreground">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {igcseTrustSignals.map((signal, index) => {
            ...
            return (
              <div
                key={signal.value}
                className="flex items-start gap-4 rounded-2xl border border-border bg-card p-4 transition-all hover:border-primary/30 hover:bg-primary/5"
              >
