...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "DLF Phase 4 sits at the centre of Gurgaon's most established residential belt, Hamilton Court, Regency Park, Carlton Estate, and the families here expect the same rigour in academics that they bring to every other decision. If your child is preparing for the Cambridge IGCSE Mathematics (0580) or Edexcel IGCSE Maths examination and needs focused, doorstep support, this page explains how IB Gram matches you with a verified IGCSE Maths home tutor in DLF Phase 4 who understands both the syllabus and your child's specific learning gaps.",
  trustPoints: [
    "Tutors verified with board-specific subject screening",
  ...
  sections: [
    ...
    {
      heading: "Why DLF Phase 4 Families Choose Home Tuition for IGCSE Maths",
      paragraphs: [
    ...
    {
      heading: "How the Cambridge IGCSE Mathematics Syllabus Is Approached in Sessions",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches You with an IGCSE Maths Home Tutor in DLF Phase 4",
      paragraphs: [
    ...
    {
      heading: "Home Visits, Online Sessions, and Hybrid, What Works in This Locality",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty, Coursework, and the Tutor's Role",
      paragraphs: [
  ...
  faqs: [
    ...
    {
      question: "What is the difference between Core and Extended tier, and how does the tutor handle it?",
    ...
    {
      question: "Can sessions happen at our home in a gated society like DLF Regency Park?",
  ...
  localKeywords: [
    ...
    "Cambridge IGCSE Mathematics tutor DLF Phase 4",
    "IGCSE 0580 tutor DLF Phase 4",
    "home tuition DLF Hamilton Court IGCSE Maths",
    "IGCSE Maths tutor DLF Regency Park Gurgaon",
    "IGCSE extended tier tutor DLF Phase 4",
    "IGCSE Maths home tutor DLF Carlton Estate",
    "IGCSE tutor near Sushant Lok 1 Gurgaon",
    "Cambridge Maths tutor Sector 27 Gurgaon",
    "IGCSE past paper practice DLF Phase 4",
    "home tutor IGCSE Maths DLF Phase 5",
    "IGCSE Maths online tutor DLF Phase 4 Gurgaon",
    "verified IGCSE Maths tutor Gurgaon DLF corridor",
    "IGCSE grade boundary revision DLF Phase 4"
  ],
};
