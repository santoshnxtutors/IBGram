...
const content: GurgaonSeoContent = {
  ...
  sections: [
    {
      heading: "Why IB Maths AA HL Demands Specialist Support",
      paragraphs: [
    ...
    {
      heading: "Home Tutoring in Ambience Island: What Families Actually Value",
      paragraphs: [
    ...
    {
      heading: "IB Maths AA HL Syllabus: What Tutors Cover Topic by Topic",
      paragraphs: [
    ...
    {
      heading: "Internal Assessment: Honest Guidance Without Crossing the Line",
      paragraphs: [
    ...
    {
      heading: "Home vs Online vs Hybrid: Choosing the Right Mode Near NH-48",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can a tutor come to our home in Ambience Caitriona for IB Maths AA HL sessions?",
    ...
    {
      question: "My child is in Year 12 and has not started the IA yet. Is it too early to get a tutor?",
      answer: "Year 12 is actually the ideal time to start. An AA HL tutor can help consolidate foundational topics while the student still has time to address gaps, and can begin guiding IA topic selection well before school deadlines hit. Starting early almost always produces better outcomes than entering Year 13 with unresolved concept gaps.",
    },
    {
      question: "What is the difference between IB Maths AA and AI, and why does it matter for choosing a tutor?",
      answer: "Analysis and Approaches emphasises algebraic rigour, proof, and pure mathematical thinking. Applications and Interpretation leans toward modelling, statistics, and technology use. They share the same IB framework but have distinct syllabi and exam styles. Tutors listed for AA HL sessions on IB Gram are vetted specifically for that course, not matched from a generic IB Maths pool.",
    },
    {
      question: "How many sessions per week do most AA HL students in this area take?",
      answer: "Most families around the NH-48 corridor settle into twice-weekly sessions of 90 minutes to two hours each during the school year. This is enough to stay ahead of the school pacing guide and work through past paper questions systematically. In the final six weeks before May or November exams, some students increase to three sessions per week focused on paper practice.",
    },
    {
      question: "Can the tutor help with the Internal Assessment without crossing academic honesty lines?",
      answer: "Yes, guiding IA topic selection, explaining the assessment criteria, reviewing drafts for structural clarity, and checking that the mathematics is accurate are all appropriate tutor roles. Writing analysis, solving the investigation, or producing sections for the student are not. IB Gram tutors understand and respect these boundaries, which protects the student's Diploma integrity.",
    },
    {
      question: "Do you have online tutors if we cannot find a home tutor who reaches Heritage City or DLF Beverly Park?",
    ...
    {
      question: "What should I share when I first contact IB Gram to find an AA HL tutor near Ambience Island?",
      answer: "Share the student's current IB year, exam session (May or November), predicted or most recent grade, the specific topics causing most difficulty, IA status, and mode preference (home, online, or hybrid). For home sessions, mention your society and preferred session days. The more specific you are, the more accurately we can match — and the faster the demo session can be arranged.",
    }
  ],
  closingCta: "If your child is working through IB Mathematics Analysis and Approaches Higher Level and the demands of the course are starting to outpace what school contact hours can cover, reaching out now, rather than closer to the exam window, gives the most time to work systematically through the syllabus. Share your requirements with IB Gram and we will work to find a verified AA HL tutor who fits your location in Ambience Island, your schedule, and your child's specific learning needs.",
  localKeywords: [
    "IB Maths AA HL tutor in Ambience Island Gurgaon",
    "IB Mathematics home tutor Ambience Island",
    "IB AA HL tutor NH-48 corridor Gurgaon",
    "IB Maths tutor Ambience Caitriona Gurgaon",
    "IB HL Maths tutor Heritage City Gurgaon",
    "IB Maths AA tutor DLF Beverly Park Gurgaon",
    "IB Diploma Maths home tutor DLF Phase 3",
    "IB Maths IA help Ambience Island Gurgaon",
    "AA HL past paper tutor MG Road Gurgaon",
    "IB home tutor Sector 24 Sector 25 Gurgaon",
    "IB Mathematics Analysis Approaches tutor Sikanderpur",
    "IB Diploma home tutor Sector 28 Gurgaon",
    "verified IB Maths AA HL tutor Gurgaon",
    "IB Year 12 Year 13 Maths tutor Ambience Island"
  ],
};
