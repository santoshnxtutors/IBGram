...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "DLF Carlton Estate sits within DLF Phase 5, one of Gurgaon's most education-conscious residential pockets along Golf Course Road. Families here, many with children pursuing IB DP or IGCSE science streams, often need a tutor who can come home, understand the specific syllabus demands of Cambridge or the IB, and work alongside school schedules without disrupting them. IB Gram connects Carlton Estate residents with verified IB and IGCSE Science home tutors whose subject expertise, board familiarity, and teaching approach are matched to your child's actual needs.",
  trustPoints: [
    "Subject-specialist IB and IGCSE science tutors",
    "Tutors screened for board-specific teaching ability",
    "Home, online, and hybrid modes available",
    "Free trial session before you commit"
  ],
  sections: [
    {
      heading: "The Academic Environment Around DLF Carlton Estate and DLF Phase 5",
      paragraphs: [
    ...
    {
      heading: "Why Home Tuition Suits DLF Carlton Estate Students in Particular",
      paragraphs: [
    ...
    {
      heading: "How IB Gram's Matching Process Works for Science Families",
      paragraphs: [
    ...
    {
      heading: "Science Syllabus Support: IGCSE and IB Specifics",
      paragraphs: [
    ...
    {
      heading: "Home, Online, and Hybrid: Choosing the Right Mode in DLF Phase 5",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty and What a Science Tutor Should and Should Not Do",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Which science subjects can IB Gram tutors cover for students in DLF Carlton Estate?",
      answer: "Tutors available through IB Gram can cover IGCSE Biology (Cambridge 0610), Chemistry (0620), and Physics (0625), as well as IB DP Biology, Chemistry, Physics, and Environmental Systems and Societies at both SL and HL. Combined or coordinated science at IGCSE is also supported. Availability of a specific tutor for a specific subject and level depends on your schedule, location within DLF Phase 5, and current tutor availability.",
    },
    {
      question: "Can a home tutor come to DLF Carlton Estate within DLF Phase 5 on school weekdays?",
      answer: "Many tutors in IB Gram's network are willing to visit DLF Phase 5 and Carlton Estate on weekday evenings, as the area is accessible from several nearby residential and commercial zones along Golf Course Road, Sector 42, and Sector 53. Exact availability depends on the tutor's own location and daily schedule. This is confirmed during the matching and demo process before any commitment is made.",
    },
    {
      question: "How does IB Gram handle the IB Science Internal Assessment process?",
      answer: "IB Science IAs are student-owned investigations. Tutors can help students understand the IA criteria, exploration, analysis, evaluation, and communication — and discuss whether their investigation design makes scientific sense. They can review structure and scientific reasoning in draft form. Writing the IA for a student or correcting substantive content is outside the tutor's role and would violate IBO academic integrity policy.",
    },
    {
      question: "What is the difference between IGCSE Core and Extended science, and does the tutor cover both?",
      answer: "Cambridge IGCSE science offers a Core tier (grades C to G) and an Extended tier (grades A* to E). Most students in DLF Carlton Estate and nearby DLF The Crest and DLF Park Place pursue the Extended tier given their school profiles. Tutors can cover both, but you should specify the tier when making the request so the right shortlist is built. Extended tier questions are more demanding and require greater analytical depth.",
    },
    {
      question: "My child takes both IB Biology HL and IGCSE Chemistry, can one tutor cover both?",
      answer: "It is possible but depends on the tutor's background. Some science tutors have strong cross-board and cross-subject range, while others specialise narrowly. If the combination is unusual, IB Gram may shortlist two tutors, one per subject or board, and you can decide based on the demo sessions. Being upfront about both subjects in the initial request is the best way to find the right arrangement.",
    },
    {
      question: "How soon before IGCSE or IB exams should families in DLF Phase 5 start home tuition for science?",
      answer: "Earlier is better, but the right starting point depends on the student's current position. Students with ongoing gaps benefit from starting at the beginning of the academic year. Students with specific topic weaknesses ahead of mock exams, typically in October-November — can benefit from a focused run of six to eight weeks. Starting one month before terminal exams is possible but limits how much ground can be covered meaningfully.",
    },
    {
      question: "Is an online science tutor from IB Gram as effective as a home tutor for Carlton Estate students?",
      answer: "For concept explanation, past paper walkthrough, mark scheme analysis, and IB IA guidance, online tutoring using shared whiteboards and screen sharing is very effective. Where home tuition has an edge is for students who need the structure of a physical presence or whose home environment is noisier. Many Carlton Estate families use a hybrid model, home sessions for deeper work, online for revision check-ins, and find it a practical balance.",
    }
  ],
  closingCta: "If your child is studying IB or IGCSE science and you are based in DLF Carlton Estate or the wider DLF Phase 5 area, IB Gram can help you find a home tutor whose board knowledge, subject depth, and teaching approach actually fit your child's needs. Share your subject, board, and preferred mode, and we will put together a shortlist and arrange a demo session at your home at a time that suits you.",
  localKeywords: [
    "IB IGCSE Science home tutor in DLF Carlton Estate DLF Phase 5 Gurgaon",
    "IGCSE Biology home tutor DLF Phase 5",
    "IB Chemistry HL tutor Golf Course Road Gurgaon",
    "home science tutor DLF Carlton Estate",
    "IGCSE Physics tutor Sector 53 Gurgaon",
    "IB science IA guidance DLF Phase 5",
    "IGCSE Alternative to Practical tutor Gurgaon",
    "IB DP Biology home tutor DLF The Crest",
    "science tutor Sector 42 Golf Course Road",
    "IGCSE Chemistry extended tier tutor DLF Park Place",
    "IB science home tutor DLF Phase 5 Gurgaon",
    "home tutor science Sushant Lok 1 Golf Course Road",
    "IB IGCSE science tutor DLF The Belaire Gurgaon",
    "verified science home tutor DLF Phase 5 Gurgaon"
  ],
};
