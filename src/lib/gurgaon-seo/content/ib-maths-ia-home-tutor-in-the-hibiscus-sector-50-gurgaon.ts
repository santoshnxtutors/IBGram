...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families living in The Hibiscus, tucked within the Nirvana Country corridor of Sector 50, often reach out to us when the IB Mathematics Internal Assessment starts feeling overwhelming. Whether your child is on the Analysis & Approaches or Applications & Interpretation pathway, the IA counts for 20% of the final IB grade, and a well-structured exploration topic, supported by a knowledgeable home tutor nearby, can make a measurable difference to predicted grades and actual scores.",
  trustPoints: [
    "Tutors experienced with IB Maths AA and AI syllabi",
    "IA topic selection, draft review and reflection support",
    "Home visits to The Hibiscus and nearby Sector 50 societies",
    "Parent demo session before regular sessions begin"
  ],
  sections: [
    {
    ...
    {
      heading: "Why The IB Mathematics Internal Assessment Deserves Dedicated Support",
      paragraphs: [
    ...
    {
      heading: "IB Maths AA vs AI: What Home Tutors in This Area Need to Know",
      paragraphs: [
    ...
    {
      heading: "How Home Tutoring Works for IB Maths IA in The Hibiscus",
      paragraphs: [
    ...
    {
      heading: "Home, Online, or Hybrid Sessions — What Families in Sector 50 Prefer",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification and Quality Checks on IB Gram",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty and the Boundaries of IA Support",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How early should we book an IB Maths IA home tutor in The Hibiscus Sector 50?",
      answer: "Ideally before the IA topic selection phase, which for most IB DP Year 1 students falls in September or October. Families in The Hibiscus and Nirvana Country who engage a tutor early get more time for topic refinement, exploratory research and unhurried drafting, all of which tend to produce stronger criterion scores. Leaving it to the second draft stage is still worthwhile, but the scope of improvement narrows.",
    },
    {
      question: "Do tutors in this area support both Maths AA and Maths AI Internal Assessments?",
      answer: "Yes. IB Gram lists tutors familiar with both Analysis & Approaches and Applications & Interpretation across SL and HL levels. When you enquire, share the specific course so we match you with a tutor whose IA experience aligns with your child's pathway. An AA HL IA has different mathematical expectations than an AI SL IA, and the topic guidance should reflect that distinction.",
    },
    {
      question: "Will a home tutor write or edit the IA directly?",
      answer: "No — and any tutor who offers to do so is working outside IBO academic honesty guidelines. Our tutors explain mathematical concepts, help with criterion understanding, review structure, and give feedback on clarity and completeness. The writing, the mathematical choices, and the Personal Engagement narrative must come from the student. This approach protects the student from honesty queries and produces a stronger, more credible final submission.",
    },
    {
      question: "Can the tutor also help with Maths Paper 1, Paper 2 and mock exam preparation?",
      answer: "Absolutely. Most families in Sector 50 book sessions that cover both IA support and exam preparation simultaneously. Past-paper practice, revision of calculus, statistics or geometry units, and timed mock drills can all be incorporated into the tutoring schedule. The balance between IA and exam prep shifts naturally as the academic year progresses and different deadlines come into focus.",
    },
    {
      question: "What mode do most families in The Hibiscus prefer, home visits or online sessions?",
      answer: "Home sessions are the preferred mode for IA-focused work in The Hibiscus and surrounding Unitech Fresco and South Close societies. In-person sessions allow easier collaboration over printed drafts and GDC output. Online sessions work well for routine concept revision. Many families use a hybrid approach: home sessions around key IA milestones and online sessions for week-to-week Maths curriculum support. Final mode depends on tutor proximity and schedule fit.",
    },
    {
      question: "How are tutors covering The Hibiscus Sector 50 verified?",
      answer: "Every tutor on IB Gram goes through identity verification, credential review and a background check. For IB Maths tutors, we additionally confirm familiarity with the current 2019-onward syllabus that introduced the AA/AI split. Subject-specific ratings collected after sessions allow families to see a tutor's performance specifically in IB Maths IA coaching, separate from their general Mathematics score.",
    },
    {
      question: "Is there a trial session before committing to regular tutoring?",
      answer: "Yes. IB Gram offers a demo session with any shortlisted tutor before you commit to a regular schedule. During this session you can assess the tutor's communication style, their familiarity with the IB Maths IA criteria, and how well they connect with your child's working pace. There is no obligation to continue after the demo, and the process is designed to make the right match rather than a fast one.",
    }
  ],
  closingCta: "If you are in The Hibiscus, Nirvana Country, Unitech Fresco or anywhere in the Sector 49 to 51 corridor and are looking for focused IB Maths IA home tutoring, IB Gram can help you find a verified, experienced tutor matched to your child's specific course and stage. Share your requirements, course pathway, IA stage, preferred schedule, and we will suggest suitable profiles promptly. A thoughtful IA is built one well-supported session at a time.",
  localKeywords: [
    "IB Maths IA home tutor in The Hibiscus Sector 50 Gurgaon",
    "IB Mathematics Internal Assessment tutor Nirvana Country",
    "IB Maths home tutor Sector 50 Gurugram",
    "IB Maths AA IA support Nirvana Country Gurgaon",
    "IB Maths AI home tutor Sohna Road Sector 50",
    "IB DP Maths tutor The Hibiscus Gurgaon",
    "home tutor IB Mathematics Unitech Fresco Sector 50",
    "IB Maths IA topic selection tutor Gurgaon",
    "IB Maths SL HL home tutor Sector 49 50 51",
    "IB Internal Assessment coaching South Close Gurgaon",
    "IB Maths past paper tutor Nirvana Country Gurugram",
    "IB Maths predicted grade support Sector 50 home tutor",
    "IB Maths IA draft review tutor The Hibiscus Gurgaon",
    "verified IB Maths tutor Sohna Road corridor Gurgaon"
  ],
};
