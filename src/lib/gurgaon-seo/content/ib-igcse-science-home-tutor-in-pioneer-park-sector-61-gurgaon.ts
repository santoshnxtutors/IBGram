...
const content: GurgaonSeoContent = {
  ...
  sections: [
    {
      heading: "The Science Landscape for Families in Pioneer Park Sector 61",
      paragraphs: [
    ...
    {
      heading: "Why Pioneer Park Families Prefer Home Tutoring for Science",
      paragraphs: [
    ...
    {
      heading: "IGCSE Science Syllabus Support, What to Expect",
      paragraphs: [
    ...
    {
      heading: "IB Diploma Science Support — HL, SL, and the IA",
      paragraphs: [
    ...
    {
      heading: "Home, Online, or Hybrid — Options for Pioneer Park Residents",
      paragraphs: [
    ...
    {
      heading: "How Tutor Verification and Matching Works on IB Gram",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty in Science Tutoring, Clear Boundaries",
      paragraphs: [
    ...
    {
      heading: "How to Get Started, What to Share When Booking",
      paragraphs: [
  ...
  faqs: [
    ...
    {
      question: "How many sessions per week do students in Grade 10 or Grade 12 typically need for IB IGCSE Science?",
      answer: "This depends on the student's current level, which science subject they are studying, the exam session timeline, and how many topics need revision. A Grade 10 student approaching their IGCSE exam series often benefits from two to three sessions weekly in the final two months. Grade 12 IB DP students with concurrent IA deadlines may need to structure sessions differently across the year.",
    }
  ],
  closingCta: "If you live in Pioneer Park or anywhere along the Sector 61 to Golf Course Extension Road corridor and your child is preparing for IB or IGCSE Science examinations, the right home tutor can make the revision process far more structured and far less stressful. Share your board, subject, and exam session with IB Gram, and we will match you with a verified science tutor who fits your schedule, your locality, and your child's exact syllabus needs.",
  localKeywords: [
    "IB IGCSE Science home tutor in Pioneer Park Sector 61 Gurgaon",
    "IGCSE Science tutor Golf Course Extension Road",
    "IB DP Biology Chemistry Physics tutor Sector 61",
    "home tutor Pioneer Park Gurgaon science",
    "IGCSE Alternative to Practical tutor Sector 62 63",
    "IB DP HL SL Science tutor Gurgaon",
    "science home tutor Ireo Grand Arch Gurgaon",
    "IGCSE Combined Science tutor M3M Merlin Sector 61",
    "IB Internal Assessment science tutor Pioneer Park",
    "science home tuition Emaar DigiHomes Gurgaon",
    "IB IGCSE tutor Sushant Lok 3 Gurgaon",
    "IGCSE past paper science tutor Sector 61 Gurgaon",
    "IB science home tutor Golf Course Extension Road"
  ],
};
