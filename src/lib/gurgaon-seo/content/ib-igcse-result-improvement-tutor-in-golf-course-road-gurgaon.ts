...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families living along Golf Course Road, in societies like The Aralias, The Magnolias, and DLF Park Place, consistently push for strong academic outcomes in both the IB Diploma Programme and IGCSE. When results fall short of predicted grades or personal targets, a focused result-improvement tutor can make the difference between clearing a retake and earning the score a student genuinely deserves. IB Gram connects Golf Course Road households with subject-matched tutors experienced in multi-subject recovery and targeted exam preparation.",
  trustPoints: [
    "Tutors matched to your exact subject mix",
    "Home, online, and hybrid sessions available",
    "Demo class before you commit",
    "Structured mock tests with written feedback"
  ],
  sections: [
    {
    ...
    {
      heading: "Why Result Improvement Needs a Different Approach",
      paragraphs: [
    ...
    {
      heading: "Multi-Subject Support Across IB and IGCSE",
      paragraphs: [
    ...
    {
      heading: "Home Tutoring Along Golf Course Road: Practical Realities",
      paragraphs: [
    ...
    {
      heading: "Online and Hybrid Options for Golf Course Road Families",
      paragraphs: [
    ...
    {
      heading: "Academic Integrity and Safe Boundaries for Assessed Work",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can one tutor cover multiple IB or IGCSE subjects for result improvement in Golf Course Road?",
      answer: "It depends on the subject combination. Some tutors on Golf Course Road are genuine multi-subject specialists, for example, covering IGCSE Mathematics and Physics together, or IB Mathematics AI and Economics. For combinations that span humanities and sciences, a coordinated pair of subject specialists sharing a schedule often works better. IB Gram will be transparent about what a single tutor can realistically cover.",
    },
    {
      question: "How quickly can result improvement tutoring begin in societies like The Aralias or The Magnolias?",
      answer: "Once you share the subject, board, grade level, and preferred schedule, IB Gram typically identifies a match within a few days. Society visitor registration may add a small lead time for home sessions, but this is usually sorted within the first week. Online sessions can begin even sooner. The earlier you reach out relative to your exam date, the better the outcome.",
    },
    {
      question: "My child is in IB Year 2 with IA deadlines approaching. Is it too late to see improvement?",
      answer: "Not at all, but the approach shifts. With IA deadlines near, the priority is often IA coaching within academic-integrity rules, helping the student understand the assessment criteria, strengthening their own draft, and identifying gaps before the final submission. Simultaneously, exam technique for the May session can run as a parallel track. Time is tighter, so a clear session plan matters more.",
    },
    {
      question: "What is the difference between a demo class and a diagnostic session in your context?",
      answer: "The demo class is primarily about fit, checking whether the student and tutor communicate well and whether the tutor's approach matches what the family is looking for. The diagnostic session, which usually comes immediately after or in the second session, involves reviewing the student's recent papers and test results to map exactly where marks are being lost and which topics need the most focused attention.",
    },
    {
      question: "Are tutors familiar with Cambridge IGCSE past papers and grade boundaries for the Golf Course Road area?",
      answer: "Yes. Tutors screened by IB Gram for IGCSE subjects are expected to work directly with Cambridge past papers, marking schemes, and published grade-boundary documents. For subjects like IGCSE Mathematics 0580, IGCSE Physics 0625, and IGCSE Chemistry 0620, the tutor will typically build a session plan around specific past-paper questions and command-word analysis rather than textbook summaries.",
    },
    {
      question: "Can sessions be arranged around school exam and co-curricular schedules common in Sector 53 and Sector 54?",
      answer: "Scheduling flexibility is built into how IB Gram matches tutors. Families in Sector 53 and Sector 54 on Golf Course Road often have students with packed afternoon schedules. Weekend morning slots and late-evening online sessions are available with some tutors. Exact availability depends on the tutor and subject, this is discussed during the matching and demo phase before any commitment is made.",
    },
    {
      question: "Does IB Gram cover Edexcel IGCSE as well as Cambridge for students in DLF Park Place or Sushant Lok 1?",
      answer: "Yes. Edexcel IGCSE has its own specification, past-paper style, and grade-boundary structure that differs meaningfully from Cambridge. For subjects like Edexcel IGCSE Mathematics A or Mathematics B, tutors need to be familiar with the specific paper structure and mark-scheme conventions. IB Gram's tutor network includes Edexcel-experienced tutors, and this is flagged clearly in the matching request.",
    }
  ],
  closingCta: "If your child's IB or IGCSE results are not where they need to be, and you live along Golf Course Road or in a nearby community like DLF Phase 5, Sushant Lok 1, or the Golf Course Extension Road corridor, IB Gram can help you find the right tutor quickly. Share the subject, board, grade level, and your preferred mode of session — home, online, or hybrid, and the matching process begins right away. A demo class lets you assess fit before any longer commitment.",
  localKeywords: [
    "IB IGCSE result improvement tutor in Golf Course Road Gurgaon",
    "IGCSE multiple subjects tutor Golf Course Road",
    "IB home tutor The Aralias Gurgaon",
    "IB tutor The Magnolias Golf Course Road",
    "IGCSE result improvement Sector 42 Sector 43 Gurgaon",
    "IB DP tutor DLF Park Place Gurgaon",
    "Cambridge IGCSE tutor Golf Course Road Gurugram",
    "IB IGCSE home tutor Sector 53 Sector 54 Gurgaon",
    "result improvement tutor Sushant Lok 1 Gurgaon",
    "IB tutor Golf Course Extension Road Gurgaon",
    "IGCSE past paper coaching Golf Course Road",
    "IB IA support tutor Golf Course Road Gurgaon",
    "multi-subject IB IGCSE tutor DLF Phase 5 Gurgaon",
