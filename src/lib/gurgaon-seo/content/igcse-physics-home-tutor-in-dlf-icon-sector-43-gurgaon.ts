...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families at DLF Icon on Sector 43's Golf Course Road corridor know that IGCSE Physics demands more than textbook reading, it rewards students who can connect theory to practical application and navigate Cambridge mark schemes with confidence. Whether your child is working through forces and motion in Year 10 or preparing for Paper 6 Alternative-to-Practical before the May/June session, an experienced IGCSE Physics home tutor in DLF Icon Sector 43 Gurgaon can make the difference between a passable grade and a strong predicted score.",
  trustPoints: [
    "Tutors verified for Cambridge IGCSE Physics syllabus",
  ...
  sections: [
    ...
    {
      heading: "Why IGCSE Physics Specifically Needs Subject-Specialist Support",
      paragraphs: [
    ...
    {
      heading: "What Families in DLF Icon Look for in a Home Tutor",
      paragraphs: [
    ...
    {
      heading: "Syllabus Coverage: Inside IGCSE Physics Paper by Paper",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can a tutor come to DLF Icon in Sector 43 for home sessions?",
      answer: "Yes, home visits to DLF Icon and the surrounding Sector 43 and Golf Course Road corridor are possible. Tutor availability for home visits depends on the individual tutor's location, their existing schedule, and your preferred session times. Families in nearby societies like The Aralias and DLF Park Place have also successfully arranged home sessions through IB Gram. It is worth confirming location accessibility when booking your demo class.",
    },
    {
      question: "Which Cambridge IGCSE Physics papers does tutor support cover?",
      answer: "Support covers all papers under the Cambridge 0625 specification, Paper 2 (multiple choice), Paper 4 (theory, Extended), and Paper 6 (Alternative-to-Practical). Tutors typically help students develop mark-scheme-aligned answering technique for theory papers and build practical reasoning skills for Paper 6. If your child's school uses a co-ordinated science variant, tutors can adapt to that specification as well.",
    },
    {
      question: "How soon before Cambridge exams should my child start tutoring?",
      answer: "Ideally, structured support begins at the start of Year 10 so the tutor can work through the full syllabus methodically. That said, students who start six to twelve weeks before their May/June or October/November Cambridge session can still make meaningful progress if sessions are focused and frequent. A tutor will assess the current level in an early session and recommend a realistic revision plan based on what is achievable in the available time.",
    },
    {
      question: "Do online IGCSE Physics sessions work as well as in-person for this subject?",
      answer: "For most IGCSE Physics content, online sessions work well when the tutor uses a shared digital whiteboard for circuit diagrams, ray diagrams, and force calculations. Paper 6 practical reasoning can also be covered online using past paper questions and discussion. Some students at DLF Icon and nearby areas prefer online for scheduling flexibility, while others prefer the focus of in-person sessions at home. A hybrid approach is also common.",
    },
    {
      question: "My child's school follows Cambridge but I am not sure of the exact paper code, does that matter?",
      answer: "Not immediately, when you get in touch, share the school name and year group and IB Gram can help identify the likely specification. Schools in the Golf Course Road area typically follow 0625 for standalone Physics. If your child has a past paper or school syllabus document, sharing it speeds up the matching process and helps tutors tailor their first session appropriately.",
    },
    {
      question: "Can the tutor help with school assignments and internal assessments?",
      answer: "Tutors can help your child understand the concepts and methods needed to complete internal assessments independently, explaining how to set up a fair experiment, how to analyse data, or how to structure a written response. They do not write or complete assessments on a student's behalf, as this would undermine both academic integrity and your child's genuine exam preparedness. The goal is always to build understanding, not to shortcut it.",
    },
    {
      question: "What is the typical cost range for IGCSE Physics home tutoring in Sector 43 Gurgaon?",
      answer: "Tutor fees vary depending on the tutor's experience, qualifications, session duration, and whether sessions are home-based or online. IB Gram does not fix a single price; you will see relevant fee information when tutor profiles are shared. Families in Sector 43, DLF Phase 5, and nearby Sushant Lok 1 typically find a range of options across experience levels. The free demo session happens before any fees are charged for regular sessions.",
    }
  ],
  closingCta: "If your child is working through Cambridge IGCSE Physics and needs structured, subject-specific support in DLF Icon Sector 43, the clearest next step is a free demo session with a verified tutor. Share your child's year group, the topics they find most difficult, and whether you prefer home visits or online — and IB Gram will match you with tutors suited to your location, schedule, and subject needs along the Golf Course Road corridor.",
  localKeywords: [
    "IGCSE Physics home tutor in DLF Icon Sector 43 Gurgaon",
    "Cambridge IGCSE Physics tutor Golf Course Road",
    "IGCSE Physics tutor Sector 43 Gurgaon",
    "home tutor DLF Icon IGCSE Physics",
    "IGCSE Physics Paper 6 tutor Gurgaon",
    "Cambridge 0625 Physics tutor Sector 43",
    "IGCSE Physics tutor The Aralias Gurgaon",
    "IGCSE Physics home tuition DLF Phase 5",
    "IGCSE Physics tutor Sushant Lok 1 Gurgaon",
    "Cambridge Physics mark scheme tutor Golf Course Road",
    "IGCSE Physics online tutor DLF Icon",
    "home tutor Sector 43 Golf Course Road Physics",
    "IGCSE Physics tutor DLF Park Place Gurgaon",
    "Cambridge IGCSE Physics extended tier tutor Gurgaon"
  ],
};
