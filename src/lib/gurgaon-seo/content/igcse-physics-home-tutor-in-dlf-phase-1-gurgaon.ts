...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "DLF Phase 1 sits at the heart of Gurugram's most established residential belt, and families here take academics seriously. If your child is working through the Cambridge IGCSE Physics syllabus and needs one-to-one support at home, IB Gram connects you with experienced tutors who understand exactly how Cambridge marks Physics answers, from command words like 'describe' and 'explain' to the practical-based Alternative to Practical (ATP) paper that trips up so many students. Tuition happens at your door, on your schedule.",
  trustPoints: [
    "Tutors experienced in Cambridge IGCSE Physics syllabus",
  ...
  sections: [
    {
      heading: "Why IGCSE Physics Demands Specialist Support",
      paragraphs: [
    ...
    {
      heading: "The Academic Landscape Around DLF Phase 1",
      paragraphs: [
    ...
    {
      heading: "Why Families in DLF Phase 1 Prefer Home Tutors Over Coaching Centres",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches You with an IGCSE Physics Home Tutor in DLF Phase 1",
      paragraphs: [
    ...
    {
      heading: "What Strong IGCSE Physics Tutoring Looks Like Week to Week",
      paragraphs: [
    ...
    {
      heading: "Home Tuition, Online Sessions, or Hybrid, Which Works Best Here",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification, Teaching Standards, and Academic Honesty",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can a tutor come to my home in DLF Beverly Park or DLF Richmond Park for IGCSE Physics?",
      answer: "Yes, home visits to residential societies within DLF Phase 1, including DLF Beverly Park, DLF Exclusive Floors, and DLF Richmond Park, are a standard arrangement. Tutor availability for home visits depends on the specific tutor's base location, existing schedule, and how far in advance you book. IB Gram matches you with tutors who have confirmed they cover this locality.",
    },
    {
      question: "My child is in Year 10 and struggling with Electricity and Circuits. How quickly can a tutor help?",
      answer: "Electricity and Circuits is one of the most frequently tested topic areas in Cambridge IGCSE Physics, and most experienced tutors can begin structured remedial work from the first or second session. With consistent weekly sessions, students typically notice improvement in their ability to attempt circuit questions within four to six weeks — though pace depends on the student's starting point and session frequency.",
    },
    {
      question: "What is the Alternative to Practical paper, and do tutors here cover it?",
      answer: "Paper 6 (Alternative to Practical) tests experimental skills on paper: planning investigations, recording and processing data, identifying errors, and suggesting improvements. Tutors matched through IB Gram are expected to dedicate specific sessions to this paper, using specimen and past ATP questions from Cambridge. It is frequently underprepared and can make a meaningful difference to the overall grade.",
    },
    {
      question: "Is there a trial or demo class before I commit to regular sessions?",
      answer: "Yes, a demo session is standard practice. It is a genuine working class, not a free consultation, where the tutor assesses the student's current level and works through targeted Physics material. After the demo, you decide whether to continue with regular sessions. This gives both student and parent a realistic sense of the tutor's teaching style before any longer commitment.",
    },
    {
      question: "Do tutors cover both Core and Extended IGCSE Physics tiers?",
      answer: "Most tutors on IB Gram who cover IGCSE Physics are familiar with both Core and Extended tier syllabuses. When you make your initial inquiry, specifying which tier your child is registered for helps IB Gram match you with a tutor whose experience aligns. Extended tier involves more quantitative problem-solving and a broader conceptual range than Core.",
    },
    {
      question: "Can sessions be online instead of at home if needed?",
      answer: "Online sessions are available and work well as a supplement or for students who prefer accessing a wider tutor pool. For Physics specifically, diagram-heavy topics are manageable online with a shared whiteboard tool. A hybrid arrangement, some home sessions, some online, is also possible and suits students in DLF Phase 1 who need scheduling flexibility around school activities and internal exams.",
    },
    {
      question: "Can the tutor help with my child's school Physics assignments and internal assessments?",
      answer: "Tutors help students understand Physics concepts, identify gaps in reasoning, and prepare for assessments — but they do not write or complete assignments on behalf of students. For internally assessed work, the tutor's role is to ensure the student understands the underlying science and can express it clearly in their own words, in line with Cambridge's academic integrity guidelines.",
    }
  ],
  closingCta: "If you live in DLF Phase 1 or the surrounding DLF corridor, whether in DLF Beverly Park, DLF Richmond Park, or near Sectors 26 to 28, and you are looking for dependable, syllabus-specific IGCSE Physics support at home, IB Gram can match you with a tutor who knows exactly how Cambridge marks these papers. Share a few details about your child's current level and schedule, and we will take it from there.",
  localKeywords: [
    "IGCSE Physics home tutor in DLF Phase 1 Gurgaon",
    "IGCSE Physics tutor DLF Phase 1",
    "Cambridge Physics home tuition DLF Phase 1",
    "home tutor DLF Beverly Park IGCSE Physics",
    "IGCSE Physics tutor Sector 27 Gurgaon",
    "Cambridge IGCSE Physics tutor near Golf Course Road",
    "IGCSE Physics Alternative to Practical tutor Gurgaon",
    "IGCSE Physics Extended tier tutor DLF corridor",
    "home tuition DLF Richmond Park Physics",
    "IGCSE Physics past paper tutor DLF Phase 1",
    "Physics home tutor Sector 26 Gurgaon",
    "IGCSE tutor DLF Exclusive Floors Gurgaon",
    "Cambridge Physics tutor near MG Road Gurgaon",
    "IGCSE Physics mock test preparation DLF Phase 1"
  ],
};
