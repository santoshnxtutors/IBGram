...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "DLF Carlton Estate is one of the quieter, more established pockets of DLF Phase 5, and families here tend to be deliberate about academics. If your child is studying IB Mathematics Analysis and Approaches SL and needs structured, one-on-one support at home, IB Gram connects you with tutors who know the AA SL syllabus inside out, from functions and calculus to the internal assessment. Sessions fit around school schedules, so learning happens without the commute.",
  trustPoints: [
    "Tutors vetted for IB AA SL subject knowledge",
    "Demo session before you commit",
    "Home, online, or hybrid, your choice",
    "Regular mock reviews and progress updates"
  ],
  sections: [
    {
      heading: "Academic Life in DLF Carlton Estate and DLF Phase 5",
      paragraphs: [
    ...
    {
      heading: "Why Carlton Estate Families Choose Home Tuition for IB Maths",
      paragraphs: [
    ...
    {
      heading: "What IB Mathematics AA SL Actually Covers",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches You with an AA SL Tutor Near DLF Phase 5",
      paragraphs: [
    ...
    {
      heading: "Home, Online, or Hybrid, Which Works Best Here?",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification and Quality Benchmarks",
      paragraphs: [
    ...
    {
      heading: "Academic Integrity and What Tutors Can Help With",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Is IB Maths AA SL significantly harder than IGCSE Additional Mathematics?",
      answer: "AA SL covers more abstract territory and demands greater proof-writing and reasoning than IGCSE Add Maths. The calculus content goes further, related rates, integration techniques, and kinematics, and the non-calculator paper in particular requires strong algebraic fluency. Students who did well in IGCSE Add Maths are in a better position, but AA SL is still a meaningful step up that most students benefit from structured tutoring support to navigate.",
    },
    {
      question: "What is the difference between IB Maths AA and IB Maths AI?",
      answer: "Analysis and Approaches (AA) emphasises mathematical rigour, proof, and abstract thinking — it suits students heading toward STEM or economics-heavy university programs. Applications and Interpretation (AI) focuses on modelling, statistics, and real-world data, with heavier use of technology. AA SL and AI HL can actually overlap in difficulty, but the content and approach differ significantly. Most tutors who specialise in AA SL will clarify this during the demo session.",
    },
    {
      question: "Can a tutor help my child with the IB Maths Internal Assessment from DLF Carlton Estate?",
      answer: "Yes, tutors can assist with understanding the IA assessment criteria, discussing topic selection, and giving formative feedback on structure, mathematical content, and clarity of argument. They cannot write the exploration or do the mathematics for the student. Families in DLF Phase 5 typically find that one or two dedicated IA-focused sessions, scheduled separately from regular revision sessions, are enough to set the student on a productive path.",
    },
    {
      question: "How many sessions per week are usually recommended for AA SL?",
      answer: "Most DP students in DLF Carlton Estate manage one to two sessions per week during the school year. In the lead-up to mock examinations or the May IB exams, some families increase to three sessions or add a focused past-paper review session. Exact frequency depends on the student's current level, how far from exams they are, and how much independent practice they are doing between sessions.",
    },
    {
      question: "Do tutors travel to DLF Carlton Estate for home sessions?",
      answer: "Subject to individual tutor availability and their proximity to DLF Phase 5 or the Golf Course Road area, home sessions at DLF Carlton Estate are available. Tutor profiles indicate the areas they cover for home visits. Availability varies by subject, exact location within the society, and preferred session times, so it is worth specifying your address and preferred days when submitting your request.",
    },
    {
      question: "My child is in DP2 with mocks coming up. Is it too late to start tutoring?",
      answer: "Not at all. DP2 students often see the sharpest improvement from targeted tutoring in the three to four months before mocks, precisely because there is a clear goal and limited time. A tutor who knows AA SL past papers well can prioritise the highest-yield topics quickly. Starting in October or November of DP2 still leaves adequate time for meaningful mock preparation and technique refinement before the May sitting.",
    },
    {
      question: "How does IB Gram handle it if the first tutor is not a good fit?",
      answer: "The demo session exists partly to surface fit issues early. If, after starting regular sessions, the match is not working, whether due to teaching style, scheduling issues, or subject depth, you can flag it through IB Gram and a replacement tutor can be arranged. The goal is a sustainable tutoring relationship, not a one-time booking, and families in DLF Phase 5 should feel comfortable requesting a change if the first match does not work out.",
    }
  ],
  closingCta: "If you are looking for an IB Maths AA SL home tutor in DLF Carlton Estate, DLF Phase 5, the next step is straightforward: share your child's year, the topics they are finding difficult, and whether you prefer sessions at home or online. IB Gram will match you with a tutor who knows the AA SL syllabus and can work within your schedule. Reach out and let us help you find the right fit.",
  localKeywords: [
    "IB Maths AA SL home tutor in DLF Carlton Estate",
    "IB tutor DLF Phase 5 Gurgaon",
    "IB Mathematics Analysis Approaches SL tuition Golf Course Road",
    "home tutor IB DP Maths DLF Carlton Estate",
    "IB AA SL tutor near DLF The Crest Gurgaon",
    "IB Maths tutor DLF Park Place Gurgaon",
    "IB DP home tuition DLF Phase 5 Gurugram",
    "IB Maths internal assessment help Gurgaon",
    "IB calculus tutor Golf Course Road Gurgaon",
    "IB Maths AA SL mock preparation DLF Phase 5",
    "home tutor Sector 42 Sector 43 IB Maths",
    "IB Diploma Mathematics tutor DLF The Belaire",
    "IB AA SL past paper practice Gurgaon home tutor",
