...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Sushant Lok 1 families searching for an experienced IGCSE Maths tutor in Gurgaon often juggle two pressures at once: a Cambridge 0580 or Edexcel syllabus that moves faster than school can cover it, and an exam calendar that waits for no one. IB Gram connects you with subject-specialist tutors who know Cambridge grade boundaries, calculator vs non-calculator paper strategies, and how to read a mark scheme, so your child builds real confidence before mock season begins.",
  trustPoints: [
    "Verified tutors with board-specific subject expertise",
    "Home, online and hybrid sessions available",
    "Demo class before you commit to a tutor",
    "Parent progress updates after every few sessions"
  ],
  sections: [
    {
      heading: "Why Sushant Lok 1 Families Prioritise IGCSE Maths Support Early",
      paragraphs: [
    ...
    {
      heading: "What the Cambridge IGCSE Maths Syllabus Actually Asks of Students",
      paragraphs: [
    ...
    {
      heading: "How Home Tutoring Works in Sushant Lok 1, Logistics and Realities",
      paragraphs: [
    ...
    {
      heading: "Online and Hybrid Options for Sushant Lok 1 Students",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification, Quality Standards and What to Ask",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty Boundaries and How a Good Tutor Handles Them",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How do I find an experienced IGCSE Maths tutor specifically for Sushant Lok 1?",
      answer: "IB Gram collects your locality, preferred session mode and syllabus details, Cambridge 0580 or Edexcel 4MA1, and matches you with tutors whose home-visit routes cover Sushant Lok 1 or who are available online at your preferred times. You receive a shortlist with tutor backgrounds before you commit to a demo class.",
    },
    {
      question: "What is the difference between Cambridge 0580 and Edexcel IGCSE Maths?",
      answer: "Cambridge 0580 and Edexcel 4MA1 cover very similar mathematical content but differ in paper structure, command word phrasing and mark scheme conventions. A tutor familiar with both can help you identify which specification your school enters you for and tailor past-paper practice accordingly, since using the wrong mark scheme can teach unhelpful response habits.",
    },
    {
      question: "Can a tutor help with both Paper 2 (non-calculator) and Paper 4 (calculator) for Cambridge 0580?",
      answer: "Yes. Experienced tutors plan session time to cover both papers rather than focusing only on one. Non-calculator fluency in arithmetic and algebra is often the weaker area for students who rely on devices, so a good tutor will identify this early and build dedicated non-calculator practice into the weekly schedule.",
    },
    {
      question: "Is home tutoring available in the internal blocks of Sushant Lok 1, or only near main roads?",
      answer: "Home sessions are available across Sushant Lok 1, including internal blocks. Actual availability depends on the tutor's travel route and your preferred session times. For addresses deeper inside the colony, a hybrid arrangement, some sessions at home and some online — can give you more scheduling options, especially for evening weekday slots.",
    },
    {
      question: "How soon before IGCSE exams should we start with a tutor?",
      answer: "Most families in Sushant Lok 1 start three to six months before the Cambridge May or November session. Starting earlier allows time to cover content gaps before shifting to intensive past-paper practice in the final six weeks. Waiting until a month before exams compresses the timeline and limits what can realistically be covered.",
    },
    {
      question: "Can students from nearby areas like DLF Hamilton Court or South City 1 also be matched?",
      answer: "Yes. Tutors who cover Sushant Lok 1 for home sessions often cover adjacent societies including DLF Hamilton Court, DLF Park Place and South City 1 as part of the same corridor. Online sessions are available regardless of exact address. When you enquire, simply mention your society and it will be included in the matching criteria.",
    },
    {
      question: "Does IB Gram guarantee specific exam results or grade improvements?",
      answer: "No. IB Gram connects students with verified, experienced tutors who are well-equipped to support IGCSE Maths preparation. Actual performance depends on the student's effort, consistency of sessions, and exam conditions. Responsible tutors track progress honestly and communicate areas of concern to parents, but no tutor or platform can guarantee specific grades.",
    }
  ],
  closingCta: "If your child is working through Cambridge 0580 or Edexcel IGCSE Maths in Sushant Lok 1 and you want a tutor who actually knows the syllabus structure, mark scheme conventions and past-paper patterns, IB Gram is where to start. Share your requirements, book a demo class, and see the difference a subject-specialist makes before you commit to a full schedule.",
  localKeywords: [
    "experienced IGCSE Maths tutor in Sushant Lok 1 Gurgaon",
    "IGCSE Maths home tutor Sushant Lok 1",
    "Cambridge 0580 tutor Sushant Lok 1 Gurugram",
    "Edexcel IGCSE Maths tutor Gurgaon",
    "IB IGCSE Maths tutor Golf Course Road Gurgaon",
    "IGCSE Maths tutor DLF Hamilton Court Gurgaon",
    "IGCSE tutor South City 1 Gurugram",
    "home tutor IGCSE Maths Sector 27 Gurgaon",
    "IGCSE Maths past paper tutor Sushant Lok",
    "IGCSE Maths tutor DLF Phase 4 Gurgaon",
    "Cambridge Maths tutor Sector 43 Gurugram",
    "IGCSE tutor near Heritage Xperiential Learning School Gurgaon",
    "online IGCSE Maths tutor Sushant Lok 1",
    "verified IGCSE Maths tutor Gurgaon home sessions"
  ],
};
