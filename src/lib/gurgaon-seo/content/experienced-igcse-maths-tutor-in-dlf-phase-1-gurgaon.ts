...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families in DLF Phase 1 know how seriously the IGCSE Mathematics syllabus weighs on a student's predicted grades and university pathway. Whether your child is working through Cambridge 0580 Extended or Edexcel IGCSE Maths, finding an experienced IGCSE Maths tutor in DLF Phase 1 Gurgaon who genuinely understands the mark scheme, not just the content, makes a measurable difference. IB Gram connects you with subject-specialist tutors who cover everything from Number and Algebra to Statistics and Probability, tailored session by session to where your child actually stands.",
  trustPoints: [
    "Verified tutors with IGCSE subject expertise",
    "Home, online, and hybrid sessions available",
    "Parent demo class before commitment",
    "Past-paper and mark-scheme focused practice"
  ],
  sections: [
    {
      heading: "IGCSE Mathematics in DLF Phase 1: What the Academic Calendar Looks Like",
      paragraphs: [
    ...
    {
      heading: "Why Families in DLF Phase 1 Prefer Home Tutors for IGCSE Maths",
      paragraphs: [
    ...
    {
      heading: "How the Matching Process Works for IGCSE Maths Tutors in This Area",
      paragraphs: [
    ...
    {
      heading: "Cambridge 0580 and Edexcel IGCSE Maths: Syllabus Support That Goes Deeper",
      paragraphs: [
    ...
    {
      heading: "Home vs Online vs Hybrid: Choosing What Works for DLF Phase 1 Students",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification and Quality: What IB Gram Checks Before a Match",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Which IGCSE Mathematics specifications do your tutors in DLF Phase 1 cover?",
      answer: "Tutors available through IB Gram in DLF Phase 1 cover Cambridge IGCSE Mathematics 0580 at both Core and Extended tiers, as well as Edexcel IGCSE Mathematics 4MA1 at Foundation and Higher tiers. When you reach out, specify your board and tier so we can match you with a tutor who has direct experience with that particular specification and its past papers.",
    },
    {
      question: "Can the tutor come to our home in DLF Beverly Park or DLF Richmond Park?",
      answer: "Yes, home sessions in DLF Beverly Park, DLF Richmond Park, and DLF Exclusive Floors are part of the standard offering. Availability depends on the tutor's existing schedule and distance from your specific address. Sharing your tower or floor block when enquiring helps us match you with someone whose commute is realistic for consistent weekly sessions.",
    },
    {
      question: "How many sessions per week is realistic for IGCSE Maths revision?",
      answer: "Most students in exam year benefit from two sessions per week, one for new content or concept consolidation and one focused on past-paper practice and mark-scheme review. During the final six weeks before the May series, some families increase to three sessions. The right frequency depends on the student's current level, how many other subjects they are managing, and how far the exam series is.",
    },
    {
      question: "My child's school uses Pathways World School Aravali's exam calendar. Does that affect tutoring timing?",
      answer: "School academic calendars shape the best tutoring schedule, particularly around internal mock exams and submission deadlines. When you share which school your child attends and the approximate dates of upcoming internal assessments, the tutor can plan sessions to support preparation for those specific milestones while keeping the overall exam-series timeline in view.",
    },
    {
      question: "Is online IGCSE Maths tutoring as effective as face-to-face for students in this area?",
      answer: "For most IGCSE Maths topics, online sessions on a shared digital whiteboard are very effective because the work is visual and written. Students in DLF Phase 1 who travel for activities or have irregular schedules often prefer online for flexibility while keeping occasional in-person sessions for intensive mock practice. Effectiveness depends more on the tutor's skill and the student's focus than on the mode.",
    },
    {
      question: "What happens in the demo session and is there a charge?",
      answer: "The demo session is a genuine working session, typically 45 to 60 minutes — where the tutor reviews a past-paper question with your child, identifies one or two specific areas to focus on, and gives you a clear picture of how regular sessions would be structured. IB Gram's current policy on demo session charges is confirmed during the initial intake call, as terms can vary.",
    },
    {
      question: "Can tutors also help students near Sector 42 and Golf Course Road who want IGCSE Maths support?",
      answer: "Yes. While this page focuses on DLF Phase 1, tutors in the IB Gram network regularly serve students in Sector 42, along the Golf Course Road corridor, and across the MG Road area. If you are based slightly outside DLF Phase 1 but nearby, mention your exact location during enquiry and we will check tutor availability for your specific address.",
    }
  ],
  closingCta: "If you are looking for an experienced IGCSE Maths tutor in DLF Phase 1 Gurgaon who understands the Cambridge 0580 mark scheme and can work around your child's school schedule, reach out through IB Gram. Share the board, current performance level, and preferred session mode, and we will suggest a tutor match and arrange a no-obligation demo class. Consistent, subject-specific support, not generic revision, is what moves the grade needle.",
  localKeywords: [
    "experienced IGCSE Maths tutor in DLF Phase 1 Gurgaon",
    "Cambridge 0580 home tutor DLF Phase 1",
    "Edexcel IGCSE Maths tutor DLF Phase 1",
    "IGCSE Mathematics home tutor DLF Beverly Park",
    "IGCSE Maths tutor near Golf Course Road Gurgaon",
    "home tutor DLF Exclusive Floors Gurgaon IGCSE",
    "IGCSE Maths past paper practice DLF Phase 1",
    "IB IGCSE Maths tutor Sector 27 Gurgaon",
    "online IGCSE Maths tutor DLF Phase 1",
    "IGCSE extended tier tutor DLF Phase 1 Gurgaon",
    "Maths tutor near MG Road Gurgaon IGCSE",
    "IGCSE Maths tutor DLF Richmond Park Gurgaon",
    "Cambridge IGCSE home tutor Sector 42 Gurgaon",
    "IB Gram IGCSE Maths tutor DLF Phase 1"
  ],
};
