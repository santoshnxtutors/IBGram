...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Pioneer Park in Sector 61 sits along one of Gurgaon's most sought-after corridors, Golf Course Extension Road, where a growing number of families have chosen IB-curriculum schools for their children. If your MYP student is finding Mathematics challenging, whether it is Number, Algebra, Geometry or Statistics, a dedicated IB MYP Maths home tutor can work through concepts at your pace, inside your home or online. IB Gram connects Pioneer Park families with verified tutors who understand the MYP framework, not just the subject.",
  trustPoints: [
    "Tutors verified through structured profile review",
    "MYP framework-specific, not generic coaching",
  ...
  sections: [
    ...
    {
      heading: "Why Home Tuition Works Particularly Well for MYP Mathematics",
      paragraphs: [
    ...
    {
      heading: "MYP Mathematics Syllabus: What Your Tutor Should Know",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches You with an IB MYP Maths Home Tutor in Pioneer Park",
      paragraphs: [
    ...
    {
      heading: "Home Sessions, Online Sessions, or Hybrid: What Families in Sector 61 Choose",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty and What a Tutor Can Appropriately Help With",
      paragraphs: [
  ...
  faqs: [
    {
      question: "What is the difference between MYP Standard and Extended Mathematics, and does the tutor support both?",
      answer: "MYP Standard Mathematics focuses on foundational number, algebra, geometry, and statistics appropriate for the MYP grade level. Extended adds greater complexity in topics like quadratics, trigonometry, and early calculus ideas, bridging toward DP Maths. When you request a tutor through IB Gram, specify which level your child is in so the matched tutor is familiar with the correct scope. Most tutors in our Sector 61 pool support both levels, but this is confirmed during the matching stage.",
    },
    {
      question: "Can an IB MYP Maths home tutor in Pioneer Park also help with investigation tasks and Criterion B?",
      answer: "Yes, and this is one of the most common reasons families in Pioneer Park seek MYP-specific tuition. A tutor can explain what Criterion B investigations expect, help the student understand the mathematical situation being explored, discuss possible approaches, and review drafts for mathematical accuracy and completeness. The student must author the reasoning and conclusions. Guiding the process is appropriate; completing it for the student is not and is outside what IB Gram tutors are engaged to do.",
    },
    {
      question: "How many sessions per week are typical for MYP Maths tuition in Sector 61?",
      answer: "Most families in Pioneer Park and surrounding societies start with two sessions per week, each 60 to 90 minutes. During a busy period — approaching end-of-unit assessments or mock examinations, some families temporarily increase to three sessions. The right frequency depends on how much ground needs to be covered and the student's workload from school. Starting conservatively and adjusting is usually more sustainable than over-scheduling in the first month.",
    },
    {
      question: "Is online MYP Maths tuition as effective as in-person sessions?",
      answer: "For MYP Mathematics specifically, online sessions using a shared whiteboard or tools like GeoGebra and Desmos are genuinely effective, particularly for algebra, functions, and statistics work. Some families in Emaar DigiHomes prefer online for scheduling flexibility. Geometric constructions and physical manipulatives work better in person. Many Pioneer Park families settle on a hybrid approach. The match quality of the tutor matters far more than the mode.",
    },
    {
      question: "Do tutors follow the specific MYP unit sequence used at a student's school?",
      answer: "Yes, if you share the current school unit or topic with the tutor, sessions can align with what is being assessed at school in the near term. Schools like GD Goenka World School and Pathways School Gurgaon may sequence units differently even in the same MYP year. Providing a copy of the school's unit plan or recent class notes helps the tutor calibrate sessions so that support is timely and directly relevant to upcoming school assessments.",
    },
    {
      question: "How long does matching usually take for families in Pioneer Park Sector 61?",
      answer: "After submitting a request with the relevant details, MYP year, level, weak areas, schedule preference, and preferred mode, IB Gram typically responds with a shortlist of matched tutor profiles within a short window. Actual availability of a suitable tutor depends on subject, grade level, location in Sector 61, and schedule compatibility. We aim to find a good fit rather than a quick but mismatched one, which is why the demo session is built into the process before any ongoing commitment is made.",
    },
    {
      question: "Can the tutor help my child prepare for the MYP 5 eAssessment in Maths?",
      answer: "Yes. MYP 5 eAssessment in Mathematics is an on-screen examination that tests all four criteria under timed conditions. Tutors experienced with MYP can work through practice tasks structured similarly to eAssessment prompts, strengthen weaker criteria, and help students manage time across different question types. Familiarity with the eAssessment format, particularly the on-screen investigation tasks — is something to confirm with the tutor during the demo session.",
    }
  ],
  closingCta: "If you are looking for an IB MYP Maths home tutor in Pioneer Park Sector 61 Gurgaon, IB Gram is a straightforward starting point. Share your child's MYP year, level, the topics or criteria causing difficulty, and your preferred schedule. We will match you with a verified tutor who understands the MYP framework, arrange a demo session, and let the quality of that session speak for itself. Availability varies by schedule and subject, so the sooner you reach out, the more options we can offer.",
  localKeywords: [
    "IB MYP Maths home tutor in Pioneer Park Sector 61 Gurgaon",
    "MYP Mathematics tutor Golf Course Extension Road",
    "IB tutor Sector 61 Gurgaon home session",
    "MYP Maths tuition Ireo Grand Arch Gurgaon",
    "IB MYP tutor M3M Merlin Sector 61",
    "MYP Mathematics home tuition Emaar DigiHomes Gurgaon",
    "IB Maths tutor near Sector 62 Sector 63 Gurgaon",
    "MYP criterion B investigation tutor Pioneer Park",
    "IB MYP Standard Extended Maths tutor Gurgaon",
    "home tutor MYP eAssessment Maths Sector 61",
    "online IB MYP Maths tuition Pioneer Park Gurgaon",
    "verified IB tutor Sushant Lok 3 corridor Gurgaon",
    "MYP 4 MYP 5 Maths tutor Golf Course Extension Road"
  ],
};
