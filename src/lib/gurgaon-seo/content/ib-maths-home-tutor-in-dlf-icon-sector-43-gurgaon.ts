...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families at DLF Icon on Sector 43 and across the Golf Course Road corridor know that IB Mathematics demands more than classroom instruction alone. Whether your child is working through the IB DP Maths Analysis and Approaches or Applications and Interpretation syllabus, a dedicated IB Maths home tutor in DLF Icon Sector 43 Gurgaon can convert scattered doubts into steady, exam-ready confidence, at a time and pace that fits your household routine.",
  trustPoints: [
    "Tutors vetted on IB subject-specific knowledge",
    "Home, online, and hybrid sessions available",
    "Free demo class before committing",
    "Matched to your child's current topic and level"
  ],
  sections: [
    {
    ...
    {
      heading: "Why IB Mathematics Needs More Than a Classroom Teacher",
      paragraphs: [
    ...
    {
      heading: "IB Maths Syllabus Coverage: What Tutors at DLF Icon Focus On",
      paragraphs: [
    ...
    {
      heading: "Why Families in DLF Icon Prefer Home Tutors Over Coaching Centres",
      paragraphs: [
    ...
    {
      heading: "Home, Online, and Hybrid Sessions: What Works for Sector 43 Residents",
      paragraphs: [
    ...
    {
      heading: "How Tutor Verification and Quality Work on IB Gram",
      paragraphs: [
    ...
    {
      heading: "Academic Integrity and What Tutors Can Ethically Support",
      paragraphs: [
    ...
    {
      heading: "Getting Started: What to Share When You Request a Match",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can I get an IB Maths home tutor who comes to DLF Icon in Sector 43?",
      answer: "Yes. IB Gram matches tutors who are willing to travel to DLF Icon on Golf Course Road for in-person home sessions. Availability depends on the tutor's location, the student's IB level and track, and mutually workable session times. A free demo class can be arranged before you commit to regular sessions so you can assess the fit in your own home.",
    },
    {
      question: "What is the difference between IB Maths AA and AI, and does it affect which tutor I need?",
      answer: "Analysis and Approaches focuses on algebraic reasoning, proof, and calculus, while Applications and Interpretation emphasises statistics, modelling, and GDC use. The two syllabuses have different paper structures and IA expectations, so it genuinely matters which track your child is on. When you request a match through IB Gram, the track and level are the first things we confirm before identifying a suitable tutor.",
    },
    {
      question: "My child's school has IA submission deadlines coming up, can a tutor help within those constraints?",
      answer: "A tutor can help your child understand the IA criteria, choose a workable topic, build the mathematical framework, and get feedback on drafts for structure and clarity. They cannot write the exploration or solve the core mathematics for the student, as this would breach IBO academic integrity policy. Schools near Sector 43, including several along Golf Course Road, take this seriously and so do tutors on this platform.",
    },
    {
      question: "Are sessions available on weekends for IB Maths students at DLF Icon?",
      answer: "Weekend availability varies by tutor and is subject to their existing commitments. Many IB students in DLF Icon and nearby societies like The Aralias and DLF Park Place prefer Saturday morning sessions to keep weekdays free for school and CAS. When you request a match, sharing your preferred time slots, including weekends — helps us identify tutors whose schedules align with yours.",
    },
    {
      question: "How quickly can we get a tutor matched for IB Maths in Sector 43?",
      answer: "Most matches for IB Mathematics in the Sector 43 and Golf Course Road area are completed within a few working days. The timeline depends on the specificity of your requirements, AA HL in Year 13 is a narrower brief than general IB Maths support, and on tutor availability at the time. Sharing details upfront, including track, level, and preferred mode, speeds up the process.",
    },
    {
      question: "What does the free demo class involve for IB Maths?",
      answer: "The demo is typically a one-hour session conducted either at DLF Icon or online, depending on your preference. The tutor usually starts with a brief conversation about the student's current syllabus position and then works through a set of topic questions or reviews a past paper extract. It gives both the student and the family a direct sense of the tutor's explanation style, knowledge depth, and communication, before any ongoing commitment is made.",
    },
    {
      question: "Can online IB Maths sessions work as well as in-person ones for my child at DLF Icon?",
      answer: "For many students, especially those comfortable with shared whiteboard tools, online sessions work very well for IB Mathematics, graphs, algebraic working, and past-paper screenshots all translate clearly to a digital environment. Some students concentrate better in-person; others prefer the flexibility of online. Hybrid arrangements, where some sessions are at home and others are online, are also common among IB families in the DLF Icon and Golf Course Road area.",
    }
  ],
  closingCta: "If you are based at DLF Icon, DLF Park Place, or anywhere along the Sector 43 and Golf Course Road stretch and want structured IB Mathematics support that fits your home and your child's school schedule, reach out through IB Gram. Share the track, level, and a few details about where your child is right now — and we will work to connect you with a verified IB Maths home tutor whose knowledge and availability are a genuine match.",
  localKeywords: [
    "IB Maths home tutor in DLF Icon Sector 43 Gurgaon",
    "IB Mathematics tutor Golf Course Road Gurgaon",
    "IB DP Maths tutor Sector 43 Gurugram",
    "home tutor DLF Icon IB Analysis and Approaches",
    "IB Maths AA HL tutor Golf Course Road",
    "IB Maths AI tutor Sector 43 Gurgaon",
    "IB Maths home tuition DLF Park Place Gurgaon",
    "IB Mathematics IA guidance Sector 43",
    "IB Maths mock practice tutor The Aralias Gurgaon",
    "home tutor DLF The Icon Sector 43 IB",
    "IB Maths online tutor Sushant Lok 1 Gurgaon",
    "verified IB Maths tutor Sector 42 Sector 53 Gurgaon",
    "IB DP tutor near Golf Course Road Gurugram",
    "IB Maths home tutor The Camellias Gurgaon"
  ],
};
