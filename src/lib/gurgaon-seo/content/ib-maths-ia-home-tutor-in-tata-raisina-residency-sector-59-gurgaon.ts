...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Families in Tata Raisina Residency, Sector 59, Gurgaon, looking for serious IB Mathematics support, particularly for the Internal Assessment, will find that generic coaching centres rarely go deep enough. IB Gram connects you with subject-specialist home tutors who understand the DP Mathematics syllabus, the IA process from topic selection to criterion-by-criterion refinement, and the realistic timelines IB schools on the Golf Course Extension Road corridor work within.",
  trustPoints: [
  ...
  sections: [
    {
      heading: "The Academic Landscape Around Tata Raisina Residency",
      paragraphs: [
    ...
    {
      heading: "Why the IB Mathematics Internal Assessment Needs Specialist Help",
      paragraphs: [
    ...
    {
      heading: "AA vs AI: Matching the Right Tutor to Your Stream",
      paragraphs: [
    ...
    {
      heading: "How Home Tutoring Works in Tata Raisina Residency",
      paragraphs: [
    ...
    {
      heading: "Subject-Specific Syllabus Support Beyond the IA",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification and What Families Can Expect",
      paragraphs: [
  ...
  localKeywords: [
    ...
    "IB Mathematics Internal Assessment tutor Sector 59",
    "IB home tutor Golf Course Extension Road Gurgaon",
    "IB Maths AA HL tutor Tata Raisina Residency",
    "IB Mathematics AI SL tutor Sector 59 Gurgaon",
    "IB IA guidance tutor Mahindra Luminare Gurgaon",
    "IB Maths home tutor Ireo Grand Arch Sector 58",
    "IB Mathematics past paper tutor Sector 60 Gurgaon",
    "IB tutor near Pathways School Gurgaon",
    "IB Maths HL Paper 3 tutor Sushant Lok 3",
    "IB home tutor Sohna Road corridor Gurgaon",
    "IB DP Mathematics Internal Assessment topic help Gurgaon",
    "verified IB Maths tutor Sector 59 Golf Course Extension"
  ],
};
