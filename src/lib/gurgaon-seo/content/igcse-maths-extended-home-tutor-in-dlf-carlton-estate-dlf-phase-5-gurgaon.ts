...
const content: GurgaonSeoContent = {
  ...
  sections: [
    ...
    {
      heading: "Why Extended Mathematics Demands Dedicated One-to-One Support",
      paragraphs: [
    ...
    {
      heading: "How Home Tutoring Works in DLF Carlton Estate",
      paragraphs: [
    ...
    {
      heading: "Matching the Right Tutor for Your Child's Extended Maths Level",
      paragraphs: [
    ...
    {
      heading: "Syllabus Coverage: What an Extended Maths Tutor Addresses Session by Session",
      paragraphs: [
    ...
    {
      heading: "Home Tuition vs Online Sessions vs Hybrid: What Works in DLF Phase 5",
      paragraphs: [
    ...
    {
      heading: "Tutor Background Verification and Academic Boundaries",
      paragraphs: [
  ...
  faqs: [
    ...
    {
      question: "Can a home tutor help with mock papers and past papers for IGCSE Maths?",
      answer: "Yes, working through past papers is central to how most tutors structure IGCSE Maths Extended preparation. Cambridge and Edexcel past papers are available through official school channels and online, and a tutor will use these to simulate exam conditions, identify error patterns, and explain mark scheme logic — including where partial marks are available and how working must be shown.",
    },
    {
      question: "Do tutors cover Edexcel IGCSE Maths as well as Cambridge for students in this area?",
      answer: "Yes. IB Gram can match tutors familiar with Edexcel IGCSE Mathematics (4MA1 Higher Tier) as well as Cambridge 0580 Extended. Schools in and around DLF Phase 5, Sector 42, and Golf Course Road follow different specifications, so it is worth confirming your child's school board when you submit your tutoring request to ensure the right specification is covered.",
    },
    {
      question: "Is online tutoring available for IGCSE Maths Extended students in DLF Carlton Estate?",
      answer: "Online sessions are available and often preferred by students who want scheduling flexibility. Sessions use video call with a shared digital whiteboard, allowing the tutor to work through problems in real time. For students in Carlton Estate with stable internet and a quiet study space at home, online tutoring for IGCSE Maths Extended is a practical and effective option alongside or instead of home visits.",
    }
  ],
  closingCta: "If your child is working through the IGCSE Maths Extended syllabus in DLF Carlton Estate or anywhere across DLF Phase 5, the right home tutor can make a measurable difference in how confidently they approach Papers 2 and 4. Share your requirements with IB Gram, board, current year, preferred session times, and any topic areas causing difficulty, and we will match you with a verified, subject-specialist tutor who suits your child's pace and your schedule.",
  localKeywords: [
    "IGCSE Maths Extended home tutor in DLF Carlton Estate",
    "IGCSE mathematics tutor DLF Phase 5 Gurgaon",
    "Cambridge 0580 Extended tutor Golf Course Road",
    "home tutor IGCSE Maths DLF Carlton Estate",
    "IGCSE Extended maths tuition DLF Phase 5",
    "Edexcel IGCSE maths tutor Sector 42 Gurgaon",
    "IGCSE maths home tutor DLF The Crest",
    "Cambridge IGCSE past paper tutor DLF Park Place",
    "IGCSE maths tutor DLF The Belaire Gurgaon",
    "online IGCSE Maths Extended tutor Golf Course Road",
    "IGCSE Extended maths mock sessions DLF Phase 5",
    "home tutor for IGCSE maths Sushant Lok 1 Gurgaon",
    "IGCSE maths tuition Sector 53 Gurgaon",
    "verified IGCSE maths tutor DLF Phase 5 Gurgaon"
  ],
};
