...
const content: GurgaonSeoContent = {
  ...
  sections: [
    ...
    {
      heading: "Why DLF Magnolias Families Choose Home Tutoring for the IB DP",
      paragraphs: [
    ...
    {
      heading: "Understanding the IB DP Multi-Subject Support Model",
      paragraphs: [
    ...
    {
      heading: "Internal Assessment, Extended Essay, and TOK — Getting the Balance Right",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches Tutors to Families in DLF Magnolias",
      paragraphs: [
    ...
    {
      heading: "Home Sessions vs Online vs Hybrid, What Works Best Here",
      paragraphs: [
    ...
    {
      heading: "Tutor Verification and What Families Should Ask Before Committing",
      paragraphs: [
    ...
    {
      heading: "Getting Started, What to Prepare When You Reach Out",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How many subjects can one tutor cover for my child's IB DP programme?",
      answer: "It depends on the subject combination. A tutor with a strong Mathematics and Physics background might credibly support both if a student is taking Maths AA and Physics. For very different groups, say, HL Economics and HL Biology, two separate specialists are usually the better approach. IB Gram maps out each subject need individually and recommends accordingly, rather than fitting everything to a single tutor for convenience.",
    },
    {
      question: "Can a tutor help with the Extended Essay without breaking IB academic honesty rules?",
  ...
  closingCta: "If your family lives in DLF Magnolias, The Camellias, The Aralias, or anywhere along the Sector 42 and Golf Course Road corridor, and your child is navigating the IB Diploma Programme, IB Gram can help you find a subject-specialist tutor who fits their subject combination, schedule, and learning style. Reach out with your child's current subject list and nearest upcoming deadline, and we will work toward arranging a demo class as efficiently as possible.",
  localKeywords: [
    "IB DP home tutor in DLF Magnolias Sector 42 Gurgaon",
    "IB tutor Golf Course Road Gurgaon",
    "IB home tutor Sector 42 Gurgaon",
    "IB DP tutor The Camellias Gurgaon",
    "IB DP tutor The Aralias Gurgaon",
    "IB tutor DLF Park Place Gurgaon",
    "IB Extended Essay tutor Sector 42 Gurgaon",
    "IB Maths AA tutor DLF Magnolias",
    "IB Chemistry HL tutor Golf Course Road",
    "IB TOK tutor Sector 42 Gurgaon",
    "IB DP home tuition Sushant Lok 1 Gurgaon",
    "IB tutor near Sector 53 Gurgaon",
    "IB DP multi-subject home tutor Gurgaon",
    "IB mock exam preparation tutor DLF Phase 5"
  ],
};
