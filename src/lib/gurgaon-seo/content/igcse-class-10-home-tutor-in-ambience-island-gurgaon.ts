...
const content: GurgaonSeoContent = {
  ...
  heroIntro: "Ambience Island's residential community along NH-48 is home to a growing number of IGCSE families who take their child's Class 10 year seriously. Whether your child is tackling Cambridge (0580, 0625, 0610, 0500) or Edexcel papers across multiple subjects, the May-June examination window demands focused, subject-specific preparation. IB Gram connects families in Ambience Island and the surrounding DLF Phase 3 corridor with verified home tutors who understand the Cambridge mark scheme, the weight of predicted grades, and how to build genuine confidence before the final sitting.",
  trustPoints: [
    "Tutors verified with subject and board checks",
    "Demo session before any commitment",
    "Multiple subjects covered under one match",
    "Flexible home, online, and hybrid scheduling"
  ],
  sections: [
    {
      heading: "The IGCSE Class 10 Academic Landscape Around Ambience Island",
      paragraphs: [
    ...
    {
      heading: "Why Home Tuition Works Particularly Well in This Neighbourhood",
      paragraphs: [
    ...
    {
      heading: "Multi-Subject IGCSE Syllabus Support: What Class 10 Students Actually Need",
      paragraphs: [
    ...
    {
      heading: "How IB Gram Matches Families in Ambience Island With the Right Tutors",
      paragraphs: [
    ...
    {
      heading: "Home, Online, or Hybrid: Choosing the Right Mode for Ambience Island Students",
      paragraphs: [
    ...
    {
      heading: "Academic Honesty and Appropriate Tutor Support for IGCSE Assessed Work",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Can one tutor cover all my child's IGCSE subjects in Ambience Island?",
      answer: "It is possible for a single tutor to cover two or three related subjects, for example, Maths and Physics, or English Language and Business Studies, but most strong IGCSE tutors are specialists in a defined subject cluster. For a student sitting five or six subjects, IB Gram typically matches two or three tutors across subject groups. We coordinate the intake so the tutors complement each other and do not create scheduling conflicts.",
    },
    {
      question: "How far in advance should we start IGCSE Class 10 tutor support?",
      answer: "For the May-June Cambridge series, starting by September or October of Class 10 gives a tutor enough time to work through past papers systematically, address conceptual gaps, and run timed mock papers before the school's own October-November internal assessments. Starting in January is still viable for targeted paper-technique support, but broad conceptual rebuilding becomes harder under time pressure. Earlier engagement consistently gives students more working room.",
    },
    {
      question: "Do tutors visit homes in Ambience Caitriona and Heritage City?",
      answer: "Yes. IB Gram matches include tutors who make home visits to residential societies along the NH-48 corridor, including Ambience Caitriona and Heritage City. Specific tutor availability for home visits depends on the tutor's location, subject, and existing schedule. Some tutors based near DLF Phase 3 or MG Road cover this corridor regularly. Availability is confirmed during the matching process and before the demo session is booked.",
    },
    {
      question: "What is the difference between Cambridge and Edexcel IGCSE, and does it affect tutor selection?",
      answer: "Cambridge (CIE) and Edexcel are different exam boards with different syllabus documents, paper structures, and mark scheme conventions. For Maths, for example, Cambridge 0580 and Edexcel IGCSE Maths have overlapping content but different paper formats and grade boundary conventions. IB Gram asks for the board upfront and matches tutors who are familiar with the specific board your child's school uses. Mixing board knowledge can create confusion, so we treat this as a core matching criterion.",
    },
    {
      question: "How does the demo session work for families in Ambience Island?",
      answer: "The demo session is a real teaching session, typically 45 to 60 minutes — where the tutor works through subject content or past paper questions with your child. You can observe or leave them to it, whichever you prefer. After the demo, you share feedback with the IB Gram team. If the tutor's style, depth, and pacing are a good match, you confirm the arrangement. If not, we revisit the shortlist. There is no pressure to commit after a single demo.",
    },
    {
      question: "Can tuition shift online if the tutor is unavailable for home visits in a given week?",
      answer: "Yes. Many tutors on IB Gram are comfortable switching between home and online sessions within the same engagement. A tutor who regularly visits a student in Sector 24 or Ambience Island might shift a session online if they have a scheduling conflict or the student is unwell. This hybrid flexibility is something to discuss with the tutor during or after the demo session, so both sides have a clear understanding of the arrangement from the start.",
    },
    {
      question: "What happens if the IGCSE tutor match is not working after a few sessions?",
      answer: "Contact the IB Gram team directly. We ask for specific feedback, which subject is the concern, what is not working (pace, depth, teaching style, availability), and use that to refine the match. The goal is a working tutor arrangement, not a permanent one that does not serve the student. Rematching is part of the process, and families should feel comfortable raising concerns early rather than waiting until the exam window is close.",
    }
  ],
  closingCta: "Families in Ambience Island, Ambience Caitriona, Heritage City, and the broader DLF Phase 3 corridor can reach out to IB Gram to start the matching process for IGCSE Class 10 home tuition. Share your subject list, upcoming assessment dates, and preferred schedule, the team will shortlist suitable tutors and arrange a demo session. Availability varies by subject, tutor, and mode, so the earlier you start the conversation, the more options you will have.",
  localKeywords: [
    "IGCSE Class 10 home tutor in Ambience Island Gurgaon",
    "IGCSE home tutor Ambience Caitriona",
    "IGCSE tutor Heritage City Gurgaon",
    "IGCSE multiple subjects tutor NH-48 corridor",
    "Cambridge IGCSE tutor DLF Phase 3 Gurgaon",
    "home tutor Ambience Island Class 10",
    "IGCSE Maths tutor Sector 24 Gurgaon",
    "IGCSE Physics tutor Sector 25 Gurgaon",
    "IGCSE home tutor DLF Beverly Park Gurgaon",
    "Class 10 IGCSE tutor MG Road Gurgaon",
    "Cambridge 0580 tutor Ambience Island",
    "IGCSE home tuition Sikanderpur Gurgaon",
    "IGCSE tutor Sector 28 Gurgaon",
    "verified IGCSE tutor Ambience Island Gurgaon"
  ],
};
