...
export async function getAdminDashboardSummary(): Promise<AdminDashboardSummary> {
  try {
    ...
    const [
      ...
      prisma.generatedPage.groupBy({ by: ["status"], _count: { _all: true } }),
      prisma.generatedPage.groupBy({ by: ["indexFlag"], _count: { _all: true } }),
      prisma.generatedPage.groupBy({ by: ["pageType"], _count: { _all: true } }),
      ...
      prisma.tutor.groupBy({ by: ["status"], _count: { _all: true } }),
