...
const ALL: CorridorKey[] = Object.keys(CORRIDORS) as CorridorKey[];
...
const DP = "IB Diploma Programme (DP): a two-year course (DP1 and DP2) of six subjects from six groups, three or four at Higher Level (HL, 240 recommended teaching hours) and the rest at Standard Level (SL, 150 hours). Each subject is graded 1-7. Theory of Knowledge (TOK) and the Extended Essay (EE) combine for up to 3 more points, so the maximum is 45; 24 points is the minimum for the diploma, subject to the IB's failing conditions. Creativity, Activity, Service (CAS) must also be completed. Exam sessions run in May (the session most Gurgaon IB schools use) and November. May results are released in early July.";
const MYP = "IB Middle Years Programme (MYP): five years (MYP 1-5, roughly ages 11-16) across eight subject groups. Every subject is assessed against four criteria (A-D), each scored 0-8; the criterion total out of 32 converts to a final 1-7 grade through IB grade boundaries. The Personal Project comes in MYP 5 (the Community Project in MYP 3 or 4). MYP eAssessment in MYP 5 (on-screen examinations plus ePortfolios) is optional, and each school decides whether to offer it.";
...
const ENGLISH_A = "DP Studies in Language and Literature: English A Language and Literature, or English A Literature. Paper 1 is guided textual analysis of unseen passages (one at SL, two at HL); Paper 2 is a comparative essay on two studied works; the Individual Oral is 15 minutes (a 10-minute analysis linked to a global issue, then 5 minutes of questions); HL students also write the HL essay of 1,200-1,500 words. The learner portfolio is required but not directly assessed.";
...
const FEES_RULE = "Never quote a rupee amount or a price range. Explain what moves the fee and how to judge value.";
